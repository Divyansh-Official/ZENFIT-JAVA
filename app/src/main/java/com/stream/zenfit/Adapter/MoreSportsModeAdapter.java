...
public class MoreSportsModeAdapter extends RecyclerView.Adapter<MoreSportsModeAdapter.SportsViewHolder> {

    private Context context;
    private List<SportsModeModal> sportsList;

    public MoreSportsModeAdapter(Context context, List<SportsModeModal> sportsList) {
    ...
    public SportsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_more_sports_mode_recycler_view_item, parent, false);
    ...
    public static class SportsViewHolder extends RecyclerView.ViewHolder {
        ...
        public SportsViewHolder(@NonNull View itemView) {
            super(itemView);
            sportsName = itemView.findViewById(R.id.moreSportsModeItemText); // Ensure this matches your XML ID
            sportsIcon = itemView.findViewById(R.id.moreSportsModeItemIcon); // Ensure this matches your XML ID
            sportsButton = itemView.findViewById(R.id.moreSportsModeItemButton); // Ensure this matches your XML ID
        }
    }
}
